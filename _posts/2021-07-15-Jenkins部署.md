...
在构建的Shell命令中获取当前拉取代码的tag信息作为变量`tagName`，若当前没有版本信息，设为default

![image-20210726100952946](https://cdn.jsdelivr.net/gh/GroundZeros/ImageHost@main/images/20210726100952.png)
...
简本修改完成后启动Jenkins构建完成后，查看项目部署目录
